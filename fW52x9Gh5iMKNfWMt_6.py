...
The Recamán Sequence is a numeric sequence that starts always with 0. The
position of a positive integer in the sequence, or Recamán Index, can be
established with the following algorithm:
...
Look at example below for the steps to do for to establish the Recamán Index
of number 2:
...
Given a positive integer `n`, implement a function that returns its Recamán
Index.
