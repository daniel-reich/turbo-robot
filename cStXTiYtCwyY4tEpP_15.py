...
Create a function that returns `True` if two lists contain identical values,
and `False` otherwise.
...
But testing the code, you see that something is not quite right. Running the
code yields the following results:
