...
​
  pk1_data = get_data(pk1)
  pk2_data = get_data(pk2)
  
  pk1_compared_pk2 = compare(pk1_data, pk2_data)
  pk2_compared_pk1 = compare(pk2_data, pk1_data)
  
  if pk1_compared_pk2 > pk2_compared_pk1:
    return pk1
  elif pk1_compared_pk2 < pk2_compared_pk1:
    return pk2
  else:
    return -1
