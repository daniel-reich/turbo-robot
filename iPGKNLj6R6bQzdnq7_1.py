...
Write **three lists** and a template string according to the following
example. Notice the keyword argument `elem`:
...
The elements of a list can be unpacked and passed to `.format()` as positional
arguments using the star operator `*`:
...
lst1 = ["John, Joe and Jack."]
lst2 = ["E, da and bit."]
lst3 = ["Metapod, Magikarp and Unown."]
​
template = "My {elem} are: {}"
