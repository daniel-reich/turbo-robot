...
A **half life** is the amount of time for **half** of a radioactive substance
to decay.
...
Create a function which calculates the remaining mass and the number of years
that it took for the substance to decay. You will be given:
...
def halflife_calculator(mass, half_life, n):
  return [round(mass / 2 ** n, 3), n * half_life]
