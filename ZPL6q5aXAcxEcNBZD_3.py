 ...
 **Mubashir** was playing with some numbers. He observed some **funny
numbers**.
...
Create a function which takes a number `n` and a positive integer `p` and
returns a positive integer `k`, such as the **sum of the digits of`n` taken to
