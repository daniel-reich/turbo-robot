...
In this series we're going to see common **redundancies** and
**superfluities** that make our code unnecessarily complicated and less
readable, and we're going to learn how to avoid them.
...
I would also add: _observe and learn from the pros_. Make a habit of checking
the **Solutions tab** after solving a challenge on Edabit. There is
**absolutely nothing wrong** in assimilating features of someone else's coding
style, especially if yours is not yet fully developed.
...
Write a function that returns `True` if the given integer is **even** , and
`False` if it's **odd**.

### Tips

 _ **Using an if statement** in order to **return boolean** or to **set a
variable to a boolean** is redundant._
