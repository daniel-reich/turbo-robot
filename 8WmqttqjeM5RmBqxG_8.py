...
Instead, you need to submit a formatted **template string** to get a certain
outcome.
...
You can pass keyword arguments to `.format()` that can then be accessed by
placing the key inside a place holder.
...
template.format("last name", me = "Doe", him ="Smith")
template.format("Eda", me = "Bit", him ="Bit")
template.format("pokemon", me = "Blastoise", him ="Charizard")
