...
John wants to save money for his first car. He puts money in his piggy bank
**every day**. Every day, he puts in $1 more than the previous day. Every
Monday he starts with a new value ⁠— $1 more than the previous Monday.
...
Write a function that returns the number of days he needs to buy his first car
`cost`. John had some `savings` (include it before counting). On the first
Monday, he puts the `start` amount into his piggy bank.
